...
import com.me.certification_nlw.modules.students.dto.StudentCertificationAnswerDTO;
import com.me.certification_nlw.modules.students.dto.VerifyHasCertificationDTO;
import com.me.certification_nlw.modules.students.entities.AnswersCertificationsEntity;
import com.me.certification_nlw.modules.students.entities.CertificationStudentEntity;
import com.me.certification_nlw.modules.students.entities.StudentEntity;
import com.me.certification_nlw.modules.students.repositories.CertificationStudentRepository;
import com.me.certification_nlw.modules.students.repositories.StudentRepository;
...
public class StudentCertificationAnswersUseCase {
	...
	public CertificationStudentEntity execute(StudentCertificationAnswerDTO dto) throws Exception{
		...
		dto.getQuestionsAnswers().stream().forEach(questionAnswer -> {
			...
			var findCorrectAlternative = question.findFirst()
					.get().getAlternatives().stream().filter(alternative -> alternative.isCorrect())
					.findFirst().get();
		...
		// Verificar se estudante existe por email
